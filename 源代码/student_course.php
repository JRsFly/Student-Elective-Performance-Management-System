...
if (!isset($_POST['search']) or $_POST['search'] == "") {
    $sql = "SELECT course.cno, course.cname, course.number, teacher.name 
            FROM course, teacher 
...
<head>
    ...
    <link rel="stylesheet" href="./style/student/student_course.css">
            ...
            <form action="select.php" method="POST">
                <div class="form">
                    ...
                    <div class="operation">
                        ...
                        <li><input id="select" type="radio" name="operation_choice" value="1" checked></li>
                        <li><input id="withdraw" type="radio" name="operation_choice" value="-1"></li>
                    </div>
